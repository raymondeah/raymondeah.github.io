    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "icon svelte-1khvto7");
    			...
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$4, 18, 24, 576);
    			attr_dev(div0, "class", "icons svelte-1khvto7");
    			add_location(div0, file$4, 14, 20, 376);
    			attr_dev(div1, "class", "title svelte-1khvto7");
    			add_location(div1, file$4, 12, 16, 293);
    			add_location(p1, file$4, 24, 20, 835);
    			add_location(b1, file$4, 25, 23, 1085);
    			add_location(p2, file$4, 25, 20, 1082);
    			attr_dev(div2, "class", "summary svelte-1khvto7");
    			add_location(div2, file$4, 23, 16, 792);
    			attr_dev(div3, "class", "desc svelte-1khvto7");
    			add_location(div3, file$4, 11, 12, 257);
    			...
    			add_location(img0, file$4, 39, 16, 1582);
    			attr_dev(div4, "class", "mobile-img svelte-1khvto7");
    			add_location(div4, file$4, 38, 12, 1540);
    			...
    			add_location(img1, file$4, 42, 16, 1705);
    			attr_dev(div5, "class", "desktop-img svelte-1khvto7");
    			add_location(div5, file$4, 41, 12, 1662);
    			attr_dev(div6, "class", "content svelte-1khvto7");
    			add_location(div6, file$4, 10, 8, 222);
    			attr_dev(div7, "class", "card svelte-1khvto7");
    			add_location(div7, file$4, 9, 4, 194);
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div0, a0);
    			mount_component(link, a0, null);
    			append_dev(div0, t4);
    			append_dev(div0, a1);
    			mount_component(github, a1, null);
    			append_dev(div3, t5);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "I'm looking for internship opportunities for Winter 2023 and Summer 2023. If you think I'm a good fit, shoot me an email! Regardless, my inbox is always open, so don't be afraid to reach out!";
    			t3 = space();
    			div9 = element("div");
    			a0 = element("a");
    			div1 = element("div");
